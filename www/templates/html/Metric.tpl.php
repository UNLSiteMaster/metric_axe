...
<p>
    ...
    <a class="wdn-button" href="javascript: (function () { 
     ...
     }());" onclick="alert('Drag this to your browser Bookmarks Bar to install.'); return false;">SiteMaster Axe</a>, then click the 'SiteMaster aXe' bookmark to run accessibility tests on any page. Note that pages are checked at a mobile width.
</p>
<?php
